...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            # 4a. Remove the newline character from the variable line
            line = line.strip()

            # 4b. Add the dogname(line) to dognames_dic if it doesn't already exist
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # 4c. Pet label is-a-dog, classifier label is-NOT-a-dog
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            # 4d. Pet label is-NOT-a-dog, classifier label is-a-dog
            # Classifier Label IS image of Dog (e.g. found in dognames_dic)
            if results_dic[key][1] in dognames_dic:
                results_dic[key].extend((0, 1))

            # 4e. Pet label is-NOT-a-dog, classifier label is-NOT-a-dog
            # Classifier Label IS NOT image of Dog (e.g. NOT in dognames_dic)
            else:
